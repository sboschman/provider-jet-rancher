...
type OpenldapObservation struct {
	ID *string `json:"id,omitempty" tf:"id,omitempty"`

	Type *string `json:"type,omitempty" tf:"type,omitempty"`
}

type OpenldapParameters struct {
...
type OpenldapSpec struct {
	...
	ForProvider     OpenldapParameters `json:"forProvider"`
}

// OpenldapStatus defines the observed state of Openldap.
type OpenldapStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OpenldapObservation `json:"atProvider,omitempty"`
}
...
type Openldap struct {
	...
	Spec              OpenldapSpec   `json:"spec"`
	Status            OpenldapStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OpenldapList contains a list of Openldaps
...
var (
	Openldap_Kind             = "Openldap"
	Openldap_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: Openldap_Kind}.String()
	Openldap_KindAPIVersion   = Openldap_Kind + "." + CRDGroupVersion.String()
	Openldap_GroupVersionKind = CRDGroupVersion.WithKind(Openldap_Kind)
)
