...
type ClusterConfigParameters struct {
	...
	// +kubebuilder:validation:Optional
	ScheduledClusterScan []ClusterConfigScheduledClusterScanParameters `json:"scheduledClusterScan,omitempty" tf:"scheduled_cluster_scan,omitempty"`
...
type ClusterConfigScheduledClusterScanObservation struct {
}

type ClusterConfigScheduledClusterScanParameters struct {
	...
	// Cluster scan config
	// +kubebuilder:validation:Required
	ScanConfig []ScheduledClusterScanScanConfigParameters `json:"scanConfig" tf:"scan_config,omitempty"`

	// Schedule cluster scan config
	// +kubebuilder:validation:Required
	ScheduleConfig []ScheduledClusterScanScheduleConfigParameters `json:"scheduleConfig" tf:"schedule_config,omitempty"`
}
...
type ScanConfigCisScanConfigObservation struct {
}

type ScanConfigCisScanConfigParameters struct {
...
type ScheduledClusterScanScanConfigObservation struct {
}

type ScheduledClusterScanScanConfigParameters struct {

	// The cluster cis scan config
	// +kubebuilder:validation:Optional
	CisScanConfig []ScanConfigCisScanConfigParameters `json:"cisScanConfig,omitempty" tf:"cis_scan_config,omitempty"`
}

type ScheduledClusterScanScheduleConfigObservation struct {
}

type ScheduledClusterScanScheduleConfigParameters struct {
